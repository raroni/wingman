# TODO: Let this class be a factory instead. There is no need for this to forward remove, activate, deactivate and so on?

module.exports = class NodeInterpreter
...
Conditional = require './node_interpreter/conditional'
