...
module.exports = class extends Janitor.TestCase
  ...
  'test single controller setup': ->
    ...
    main_controller.setupController main_controller.constructor.UserController
    ...
    @assert main_controller.controllers.user.options.view instanceof main_controller.constructor.UserView
